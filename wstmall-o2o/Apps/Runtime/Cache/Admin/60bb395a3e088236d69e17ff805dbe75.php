...
<html lang="zh-cn">
   ...
   <body>
      <div class='panel wst-panel-full'>
         ...
         <div class='col-xs-12 wstmall-accredit-tips'>系统检测到您未获取授权，点此<a target='_blank' href='http://www.wstmall.net/index.php?m=Home&c=License&a=getLicense'>获取系统授权码</a></div>          
         <div class='row' style='padding-left:10px;margin-right:10px;'>
	        ...
	        <div class="col-md-3">
	           <div class="box-header" style='margin-bottom:30px;'>
	             ...
	             <div><a style='color:#000000' href="<?php echo C('WST_WEB');?>" target='_blank'>官网：<?php echo C('WST_WEB');?></a></div>
	             <div><a style='color:#000000' href="http://bbs.wstmall.net" target='_blank'>使用交流：http://bbs.wstmall.net</a></div>
	           </div>
	           <div class="box-header" style='margin-bottom:30px;'>
	             <h4 class='wstmall-intro'>开发团队： </h4>
	             <div>广州商淘信息科技有限公司</div>
	           </div>
	           <div class="box-header" style='margin-bottom:30px;'>
