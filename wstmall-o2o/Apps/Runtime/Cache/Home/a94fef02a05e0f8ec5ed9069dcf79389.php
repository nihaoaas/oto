...
<html lang="zh-cn">
	<head>
     	...
     	<link rel="stylesheet" href="/wstmall-o2o/Apps/Home/View/default/css/goodslist.css" />
...
<div class="headNav">
				...
				<div class="wst-goods-page">
					<?php if(is_array($pages['root'])): $key = 0; $__LIST__ = $pages['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($key % 2 );++$key;?><li class="wst-goods-item">
						<div class="goods-img">
							...
							<img class='lazyImg' data-original="/wstmall-o2o/<?php echo ($goods['goodsThums']); ?>" width="180" />
							</a>
						</div>
						<div class="goods-des">
	...
	<script src="/wstmall-o2o/Apps/Home/View/default/js/common.js" type="text/javascript"></script>
	<script src="/wstmall-o2o/Apps/Home/View/default/js/goods.js"></script>
	<script>
